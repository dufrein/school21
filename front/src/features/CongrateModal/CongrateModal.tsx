...
export const CongrateModal: React.FC<CongrateModalProps> = (props) => {
  ...
  return (
    <Modal isOpened={isOpened} onClose={onClose} className={styles.modal}>
      ...
      Переходите к следующему, а если вы прошли все курсы на вашем уровне знаний, переключите в
      настройках свой уровень знаний на более высокий! Если же вы прошли самый сложный курс, то
      можете обратиться к репетиторам из раздела{" "}
      <NavLink href={ROUTES.TEACHERS} onClick={onClose}>
        Учителя
      </NavLink>
    </Modal>
  );
